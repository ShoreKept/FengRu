...
import h5py
from utils.eval_utils_new import *
...
parser.add_argument('--task', type=str, choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping', 'EGFR_subtyping'])
...
if __name__ == "__main__":
    ...
    for ckpt_idx in range(len(ckpt_paths)):
        ...
        fold_label_b=label_binarize(fold_label,classes=[0,1,2,3,4])
    ...
    label_dict = {0:'Normal', 1:'L858R', 2:'Other', 3:'19DEL', 4:'Wild'}
    ...
    plt.title('ROC Curve for 5-Class Problem with 10-Fold CV')
