...
parser.add_argument('--task', type=str, default='EGFR_Four_subtyping_fengru', choices=['task_1_tumor_vs_normal', 'task_2_tumor_subtyping', 'EGFR_subtyping', 'EGFR_Four_subtyping_fengru'])
