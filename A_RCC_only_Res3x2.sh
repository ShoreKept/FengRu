...
--lr 2e-4 \
--k 10 \
--results_dir /home/graduate2024/code/baseline/CLAM-master/results/RCC_only_Res3x2_UNI_d1024 \
--split_dir /home/graduate2024/code/zxb/CLAM-master/splits/RCC_fengru_100 \
--exp_code RCC_only_Res3x2_fengru \
...
--embed_dim 1024 \
> out_RCC_train_only_Res3x2.log 2> error_RCC_train_only_Res3x2.log &