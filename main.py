...
from utils.core_utils_1 import train
from dataset_modules.dataset_generic_1 import Generic_WSI_Classification_Dataset, Generic_MIL_Dataset
...
def main(args):
    ...
    with open(os.path.join(args.results_dir, "README.txt"), 'a', encoding='utf-8') as file:
        file.write(f"k_samples: {args.B}\n")
...
# parser.add_argument('--split_dir', type=str, default='/home/graduate2024/data_new/splits', 
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes=4
    dataset = Generic_MIL_Dataset(csv_path = '/home/graduate2024/data_new/CLAM_csv/EGFR_CLAM_kb.csv',
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = '/home/graduate2024/data_new/CLAM_csv/tcga_rcc.csv',
                            data_dir= args.data_root_dir,
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
    ...
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = '/home/graduate2024/data_new/CLAM_csv/tcga_luad.csv',
                            data_dir= args.data_root_dir,
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
