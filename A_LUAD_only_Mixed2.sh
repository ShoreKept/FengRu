...
--lr 2e-4 \
--k 10 \
--results_dir /home/graduate2024/code/baseline/CLAM-master/results/LUAD_only_Mixed2_UNI_d1024 \
--split_dir /home/graduate2024/code/baseline/CLAM-master/splits/LUAD_fengru_100 \
--exp_code LUAD_only_Mixed2_fengru \
...
--embed_dim 1024 \
> out_LUAD_train_fengru_only_Mixed2.log 2> error_LUAD_train_fengru_only_Mixed2.log &