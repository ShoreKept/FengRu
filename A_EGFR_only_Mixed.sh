...
--lr 2e-4 \
--k 10 \
--results_dir /home/graduate2024/code/baseline/CLAM-master/results/EGFR_Mixed_UNI_d1024 \
--split_dir /home/graduate2024/code/baseline/CLAM-master/splits/EGFR_Five_subtyping_fengru_100 \
--exp_code EGFR_Mixed_fengru \
...
--embed_dim 1024 \
> out_EGFR_train_fengru_Mixed.log 2> error_EGFR_train_fengru_Mixed.log &