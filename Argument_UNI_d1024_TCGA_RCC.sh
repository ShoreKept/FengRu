...
--lr 2e-4 \
--k 10 \
--results_dir /home/graduate2024/code/zxb/CLAM-master/results/EGFR_Five_UNI_d1024 \
--split_dir /home/graduate2024/code/zxb/CLAM-master/splits/EGFR_Five_subtyping_fengru_100 \
--exp_code EGFR_Five_subtyping_fengru \
...
--embed_dim 1024 \
> out_EGFR_train_fengru_UNI_d1024_Five.log 2> error_EGFR_train_fengru_UNI_d1024_Five.log &