...
--lr 2e-4 \
--k 10 \
--results_dir /home/graduate2024/code/baseline/CLAM-master/results/EGFR_only_8parralel_UNI_d1024 \
--split_dir /home/graduate2024/code/baseline/CLAM-master/splits/EGFR_Five_subtyping_fengru_100 \
--exp_code EGFR_only_8parralel_fengru \
...
--embed_dim 1024 \
> out_EGFR_train_only_8parralel.log 2> error_EGFR_train_only_8parralel.log &